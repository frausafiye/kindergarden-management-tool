        ...
        <div className={styles.icons}>
          <div className={styles.icon}>
            ...
            <p className={styles.ptag}>
              Manage teachers and groups and access information about them
              quickly and easily
            </p>
          </div>
          <div className={styles.icon}>
            <p>{calendar1}</p>
            <p className={styles.ptag}>
              Overview of the group calendar and year schedule, as well as the
              attendence lits
            </p>
          </div>
          <div className={styles.icon}>
            ...
            <p className={styles.ptag}>
              Create the group schedule and set meetings and events fast and
              easily
            </p>
          </div>
          <div className={styles.icon}>
            <p>{check}</p>
            <p className={styles.ptag}>
              Child information in one click, avoiding mistakes, making easy and
              more assertive the teachers decisions
            </p>
          </div>
        </div>
      </div>
